...
# to receive the arguments and they ust be placed within the pupe symbols
# |params, ....|
...
# This method uses the call method that has been provided arugments.
