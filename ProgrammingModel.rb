...
# Mathematical and comparision operators are treated like methods in Ruby.
...
# of an object on which they're called have the exlamation mark at the end. There is 
# always a second version of these methods that don't have the exclamation mark. 
# They don't modify the state of the object. They make a copy of the object and then
# modify the copy.
str = "Jin Joint"
upStr = str.upcase
puts upStr
...
# Write the lines of code that tell us the class of 5.2 and the meothds available to it.
puts 5.2.class
